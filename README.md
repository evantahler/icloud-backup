...
![Four-lane backup in progress](docs/assets/backup.gif)
...
![icloud-backup doctor](docs/assets/doctor.png)
...
Screenshots and GIFs in this README are regenerated by `bun run capture` —
see [`docs/captures.md`](docs/captures.md) for the VHS + fake-source pipeline.

## Development

If you have a JavaScript runtime installed and prefer to run from the npm registry instead of the standalone binary:
